...
profile:
  ...
  more_info: >
    <center> <p style="font-family: times, serif; font-size:11pt; font-style:italic">
...
<a href="{{ 'sepehr_hajebi_cv.pdf' | prepend: 'assets/pdf/' | relative_url}}" target="_blank" rel="noopener noreferrer"><i class="fas fa-file-pdf"></i> CV</a> (updated Oct 15, 2023)
